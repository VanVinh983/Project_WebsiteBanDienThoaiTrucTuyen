...
<body>
	...
	<!--------------------------------------------------CHI TIẾT SẢN PHẨM---------------------------------------------------------------->
	<div class="container-fluid mt-1 border-bottom ">
		<div class="container-fluid ">
	...
	<div class="container-fluid mt-1 ">
		<div class="container-fluid ">
			<div class="row ">
					...
					<div class="row ">
						...
						<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 text-left mt-1 ">
							<input type="button " class="btn btn-danger " value="Trả góp 0% "
								name=" "
								style="font-size: 11px; color: white; font-weight: bold;"
								readonly><br>
						</div>
					...
					<div class="row mt-2 border ">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left ">
							...
							<form class="border border-danger ">
								...
								<br> <span><i
									class="far fa-check-circle text-left border "></i> &nbsp;Giảm
									ngay 1.5 triệu (áp dụng đặt và nhận hàng <br>&emsp;
									&ensp;từ 15 - 25/7) (đã trừ vào giá) <label for="sao "
									id="sao " style="color: red;"><b>*</b></label></span><br>
							</form>
							<span style="color: red;"><label
								style="color: red; font-weight: bold;">* &nbsp;</label>Không áp
								dụng khi mua trả góp 0%</span>
						</div>
					</div>
					...
					<div class="row mt-2 ">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left ">
							<button class="btn btn-warning ">
								<input type="checkbox "
									class="checkbox-inline checkbox-danger checkbox-warning "><b
									style="color: black;">&nbsp;Yêu cầu nhân viên kỹ thuật giao
									hàng:</b> hỗ trợ copy danh bạ, hướng dẫn sử dụng máy mới, giải đáp
								thắc mắc sản phẩm.
							</button>
						</div>
					</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 text-left pt-2 ">
					<div class="row ">
						<div
							class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left text-center ">
							<a href="javascript:void(0) target="
								_blank" rel="noopener noreferrer"
								style="text-decoration: none; font-size: 15px;"> <i
								class="material-icons">edit_location</i>Kiểm tra có hàng tại nơi
								bạn không?
							</a>
						</div>
					...
					<div class="container border">
						<div class="row mt-2 ">
							...
							<div class="col-xs-12 col-sm-11 col-md-11 col-lg-11 text-left">
								<span><i class='fab fa-product-hunt btn-danger mt-2'></i>
									...
									style="text-decoration: none;"> Sạc, Tai nghe, Hộp, Cáp,
										Cây lấy sim, Sách hướng dẫn</a></span><br>
							</div>
						</div>
						<div class="row mt-2 ">
							<div class="col-xs-12 col-sm-1 col-md-1 col-lg-1 text-left   ">
							...
							<div
								...
								<span><i
									class="material-icons btn-danger border-top mt-2"
						...
						<div class="row mt-2 ">
							...
							<div
								class="col-xs-12 col-sm-11 col-md-11 col-lg-11 text-left border-top">
								<span><i class="fa fa-clock-o btn-danger border-top mt-2"></i>
									Lỗi là đổi mới trong 1 tháng tại hơn 2025 siêu thị toàn quốc
									Xem chi tiết<br>&nbsp;</span>
							</div>
						</div>
					</div>
	...
	<div class="container-fluid mt-2">
		<div class="container-fluid border">
			<div class="row">
				<!---------------------------------------------------------------------THÔNG SỐ KỸ THUẬT------------------------------------------------------------------->
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left mt-12 ">
					<div class="row">
					...
					<div class="row border-top mt-2">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 text-left mt-2">
							<label> <a href="javascript:void(0)"
								style="text-decoration: none;">OLED</a> , 6.5", <a
								href="javascript:void(0)" style="text-decoration: none;">Super
									Retina XDR</a></label>
						</div>
					</div>
					<div class="row border-top mt-2">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 text-left mt-2">
							<label> <a href="javascript:void(0)"
								style="text-decoration: none;">iOS 13</a>
							</label>
						</div>
					</div>
					<div class="row border-top mt-2">
					...
					<div class="row border-top mt-2">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 text-left mt-2">
							<label> <a href="javascript:void(0)"
								style="text-decoration: none;">Apple A13 Bionic 6 nhân</a>
							</label>
						</div>
					</div>
					<div class="row border-top mt-2">
					...
					<div class="row border-top mt-2">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 text-left mt-2">
							<label> <a href="javascript:void(0)"
								style="text-decoration: none;">1 eSIM & 1 Nano SIM, Hỗ trợ
									4G</a>
							</label>
						</div>
					</div>
					<div class="row border-top mt-2">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 text-left mt-2">
							<label>
								<button class="btn btn-danger" style="font-size: 50%;">HOT</button>
								<a href="javascript:void(0)" style="text-decoration: none;">
									&nbsp; SIM VNMB Sieu sim (5GB/ngày)</a>
							</label>
						</div>
					</div>
					<div class="row border-top mt-2">
					...
					<div class="row border-top mt-2">
						<div
							class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center mt-2 "
							id="xemThemCauHinhChiTiet">
							<a href="javascript:void(0)"> <input type="button"
								class="btn btn-primary form-control"
								value="Xem thêm cấu hình chi tiết" name="" id=""
								data-target="#exampleModalLong_ChiTiet" data-toggle="modal">
							</a>
						</div>
					</div>
					<div class="row  mt-5 ">
					...
					<div class="row border-top mt-2 ">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center mt-2 ">
							<img
								src="../images/ChiTietSanPham/HuongDaniPhone/so-sanh-iphone-se-2020-va-iphone-11-dieu-gi-lam-nen-su-thb.jpg"
								alt="" class="src" width="100%">
						</div>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left mt-2 ">
							<p>
								iPhone SE 2020 và iPhone 11 Điều gì làm nên sự khác biệt?<br>
					...
					<div class="row border-top mt-2 ">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center mt-2 ">
							<img
								src="../images/ChiTietSanPham/HuongDaniPhone/cach-tai-cai-dat-bo-hinh-nen-iphone-11-iphone-11-thumb.jpg"
								alt="" class="src" width="100%">
						</div>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left mt-2 ">
							<p>
								Cách tải cài đặt bộ hình nền iPhone 11, iPhone 11 Pro mới nhất<br>
					...
					<div class="row border-top mt-2 ">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center mt-2 ">
							<img
								src="../images/ChiTietSanPham/HuongDaniPhone/cach-tim-lai-tai-khoan-icloud-apple-id-don-gian-nhanh-chong-thumb-1.jpg"
								alt="" class="src" width="100%">
						</div>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left mt-2 ">
							<p>
								Cách tìm lại tài khoản iCloud Apple ID đơn giản, nhanh chóng<br>
					...
					<div class="row border-top mt-2 ">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center mt-2 ">
							<img
								src="../images/ChiTietSanPham/PhuKieniPhone/tai-nghe-ep-mozard-ds509-wb-xam-1-600x600.jpg"
								alt="" class="src" width="100%">
						</div>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left mt-2 ">
							<p>
								<b>Tai nghe EP Mozard DS509-WB Xám </b> <br> <span
									style="color: red"><b>116.000₫ </b></span><span>&emsp;<strike>
										299.000₫</strike></span>
							</p>
					...
					<div class="row border-top mt-2 ">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center mt-2 ">
							<img
								src="../images/ChiTietSanPham/PhuKieniPhone/adapter-sac-1a-ava-jc62-1-600x600.jpg"
								alt="" class="src" width="100%">
						</div>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left mt-2 ">
							<p>
								<b>Adapter Sạc 1A AVA JC62</b> <br> <span
									style="color: red"><b>99.000₫ </b></span><span>&emsp;<strike>
										199.000₫</strike></span>
							</p>
					...
					<div class="row border-top mt-2 ">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center mt-2 ">
							<img
								src="../images/ChiTietSanPham/PhuKieniPhone/cap-lightning-20cm-ava-speed-ii-trang-1-1-600x600.jpg"
								alt="" class="src" width="100%">
						</div>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left mt-2 ">
							<p>
								<b>Cáp Lightning 20 cm AVA Speed II Trắng </b> <br> <span
									style="color: red"><b>50.000₫ </b></span>
							</p>
					...
					<div class="row border-top mt-2 ">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center mt-2 ">
							<img
								src="../images/ChiTietSanPham/PhuKieniPhone/cap-lightning-20cm-evalu-ltl-02-avatar-1-600x600.jpg"
								alt="" class="src" width="100%">
						</div>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left mt-2 ">
							<p>
								<b>Dây cáp Lightning 20 cm e.VALU LTL-02 </b> <br> <span
									style="color: red"><b>70.000₫</b></span>
							</p>
					...
					<div class="row border-top mt-2 ">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center mt-2 ">
							<img
								src="../images/ChiTietSanPham/PhuKieniPhone/op-lung-iphone-11-pro-max-nhua-deo-luggage-nake-sl-1-600x600.jpg"
								alt="" class="src" width="100%">
						</div>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left mt-2 ">
							<p>
								<b>Ốp lưng iPhone 11 Pro Max nhựa dẻo Luggage Nake Slim JM
									Nude </b> <br> <span style="color: red"><b>35.000₫
								</b></span><span>&emsp;<strike> 70.000₫</strike></span><br>
								<button class="btn btn-danger" style="height: 10%;">Giảm
									50%</button>
							</p>
					...
					<a href="chitetsanpham.html"
						...
						<div class="card-body">
							...
							<p class="card-text">
								...
								<span>Tặng 2 suất mua tai nghe cực xịn (không áp dụng
									thêm khuyến mãi khác) </span>
							</p>
						</div>
					</a>
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 ">
				<div class="card text-center" style="">
					<a href="chitetsanpham.html"
						style="text-decoration: none; color: black;"> <img
						class="card-img-top"
						src="../images/iPhone/iphone-xs-max-256gb-white-400x460.png"
						alt="Card image" style="width: 50%">
						<div class="card-body">
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 ">
				<div class="card text-center" style="">
					<a href="chitetsanpham.html"
						style="text-decoration: none; color: black;"> <img
						class="card-img-top"
						src="../images/iPhone/iphone-se-256gb-2020-261820-101806-400x460.png"
						alt="Card image" style="width: 50%">
						<div class="card-body">
