...
<nav
			...
			<a class="navbar-brand border " href="index_1.html"
				style="width: 7%;"> <img src="${img}/logo.png" alt=""
				class="src" style="width: 100%; height: 10%;">
			</a>
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav position-relative m-auto"
					...
					<li class="nav-item position-relative pr-10"><a
						class="nav-link position-relative ml-20" href="${pageContext.request.contextPath}/dienthoai/danhsach"><i
					...
					<li class="nav-item position-relative"><a
						class="nav-link position-relative  href="#"><i
							class="fa fa-user" aria-hidden="true" data-toggle="modal"
